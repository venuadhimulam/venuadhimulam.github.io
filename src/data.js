export const experience = [
  ...
  {
    role: "Software Engineer",
    company: "Drughelp.care · Cleveland State University",
    period: "Jul 2022 — May 2023",
    location: "Cleveland, Ohio",
    summary:
      "Built digital tools for a research-backed public resource supporting people affected by the opioid crisis.",
    outcomes: [
      "Designed, developed, and deployed a support chatbot for website visitors.",
      "Improved site performance by 40% and introduced analytics to better understand user behavior.",
      "Worked across product design, front-end development, APIs, deployment, and measurement.",
    ],
    stack: ["React", "Redux", "Laravel", "AWS", "MySQL"],
  },
  {
  ...
  },
  {
    ...
    summary:
      "Started a professional engineering career creating responsive, dynamic web experiences for clients.",
    outcomes: [
      "Built client-facing pages and strengthened practical front-end development skills.",
    ],
